...
('piotr.nowak@example.com', '18-24', 'Male', 'Krak�w'),
('joanna.zielona@example.com', '35-44', 'Female', 'Wroc�aw'),
('marek.bialy@example.com', '30-39', 'Male', 'Pozna�'),
('alicja.smart@example.com', '25-34', 'Female', 'Gda�sk');

-- Client
INSERT INTO Client (NameAndSurname, NIP)
VALUES
('Micha� Brzozowski', '1112223334'),
('Karolina Zieli�ska', '9876543210'),
...
INSERT INTO Views_Clicks (
    Campaign_ID, View_Click, Click_Profit, User_ID, Time_ID, Date_ID, OContract_ID, CContract_ID)
VALUES
(1, 1, 0.00, 1, 1, 1, 1, 1), -- view
(1, 0, 3.50, 2, 2, 2, 1, 1), -- click
(2, 1, 0.00, 3, 3, 3, 2, 2), -- view
(2, 0, 2.75, 4, 4, 4, 2, 2), -- click
(3, 0, 1.90, 5, 5, 5, 1, 3); -- click


INSERT INTO InterestLog (ViewClick_ID, Interest_ID)
VALUES
(1, 1), 
(1, 2), 
(2, 2), 
